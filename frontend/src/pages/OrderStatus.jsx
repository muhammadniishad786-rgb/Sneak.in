...
function OrderStatus() {
  ...
  // Separate loading state for cancellation
    ...
    <div className="min-h-screen bg-slate-50 px-4 py-8 sm:px-6 sm:py-10 lg:px-8">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="text-center">
          ...
          >
            {isCancelled ? (
              <FiXCircle size={34} className="text-red-500" />
            ) : (
          ...
          <p className="mx-auto mt-3 max-w-xl text-sm leading-6 text-slate-500 sm:text-base">
            {isCancelled
              ? "This order has been cancelled successfully. The items have been returned to available stock."
              : "Thank you for shopping with Sneak.in. Your order has been received and is being processed."}
          </p>
        </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm leading-6 text-red-600">
                        ...
                        The product stock has been restored.
                      </p>
